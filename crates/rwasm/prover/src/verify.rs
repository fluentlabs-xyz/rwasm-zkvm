...
use rwasm_executor::{subproof::SubproofVerifier, SP1ReduceProof};
use rwasm_machine::cpu::MAX_CPU_LOG_DEGREE;
...
impl<C: SP1ProverComponents> SubproofVerifier for SP1Prover<C> {
    fn verify_deferred_proof(
        &self,
        proof: &rwasm_machine::reduce::SP1ReduceProof<BabyBearPoseidon2>,
